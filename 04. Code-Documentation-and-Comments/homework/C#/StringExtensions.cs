...
{
    /// <summary>
    /// Encrypting input string to MD5 hash function.
    /// </summary>
    /// <param name="input">Incoming text.</param>
    /// <returns>Input text with MD5 standart.</returns>
    ...
    /// <summary>
    /// Check value of incoming string text. 
    /// </summary>
    /// <param name="input">Incoming text.</param>
    ...
    /// </summary>
    /// <param name="input">Incomming string</param>
    ...
    /// </summary>
    /// <param name="input">Incoming string</param>
    /// <returns>Parsed short number or 1/1/0001 12:00:00 AM.</returns>
